...
class _YouState extends State<You> {
  int _currentIndex = 0;
  final tabs = [
    SizedBox(height: 600, width: 400, child: Youlis()),
    Center(child: Text('kjhk')),
    Center(child: Text('new')),
    Center(child: Text('dada')),
    Center(child: Text('dter')),
  ];
  @override
            ...
            actions: [
              ...
              CircleAvatar(
                ...
                backgroundImage: NetworkImage(
                    'https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDZ8fHBlcnNvbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60'),
              ),
              SizedBox(width: 10)
            ],
          ),
